...
static const char qt_meta_stringdata_stefanfrings__TemplateCache[] = {
    "stefanfrings::TemplateCache\0"
};
...
const QMetaObjectExtraData stefanfrings::TemplateCache::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject stefanfrings::TemplateCache::staticMetaObject = {
    { &TemplateLoader::staticMetaObject, qt_meta_stringdata_stefanfrings__TemplateCache,
      qt_meta_data_stefanfrings__TemplateCache, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &stefanfrings::TemplateCache::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_stefanfrings__TemplateCache))

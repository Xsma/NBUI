...
static const char qt_meta_stringdata_stefanfrings__HttpSessionStore[] = {
    "stefanfrings::HttpSessionStore\0\0"
    "sessionTimerEvent()\0"
};
...
const QMetaObjectExtraData stefanfrings::HttpSessionStore::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject stefanfrings::HttpSessionStore::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_stefanfrings__HttpSessionStore,
      qt_meta_data_stefanfrings__HttpSessionStore, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &stefanfrings::HttpSessionStore::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_stefanfrings__HttpSessionStore))

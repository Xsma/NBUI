...
static const char qt_meta_stringdata_stefanfrings__HttpListener[] = {
    "stefanfrings::HttpListener\0\0"
    "socketDescriptor\0handleConnection(tSocketDescriptor)\0"
};
...
const QMetaObjectExtraData stefanfrings::HttpListener::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject stefanfrings::HttpListener::staticMetaObject = {
    { &QTcpServer::staticMetaObject, qt_meta_stringdata_stefanfrings__HttpListener,
      qt_meta_data_stefanfrings__HttpListener, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &stefanfrings::HttpListener::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_stefanfrings__HttpListener))
